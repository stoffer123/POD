...
KPR_uniforms = [
	...
	["rhs_uniform_mflora_patchless", 4],
    ["rhs_uniform_emr_patchless", 4],
    ["rhs_uniform_vdv_emr", 4],
    ["rhs_uniform_msv_emr", 4],
    ["rhs_uniform_emr_des_patchless", 4],
    ["rhs_uniform_mvd_izlom", 4],
    ["rhs_uniform_m88_patchless", 4],
	["rhs_uniform_flora_patchless", 4],
    ["rhs_uniform_flora_patchless_alt", 4],
    ["U_O_R_Gorka_01_F", 4],
    ["U_O_R_Gorka_01_brown_F", 4],
    ["U_O_R_Gorka_01_camo_F", 4],
    ["U_O_R_Gorka_01_black_F", 4],
